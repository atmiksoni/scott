...
(function (RongWebIMWidget) {
    var conversation;
    (function (conversation) {
        var UploadImageDomain = "http://ovjgba4hq.bkt.clouddn.com/";
            ...
            function ConversationController($scope, conversationServer, WebIMWidget, conversationListServer, widgetConfig, providerdata, RongIMSDKServer) {
                ...
                function uploadFileRefresh() {
                    ...
                    qiniuuploader = Qiniu.uploader({
                        ...
                        filters: {
                            mime_types: [{ title: "Image files", extensions: "*" }],
        ...
        var conversationItem = (function () {
            function conversationItem(conversationServer, conversationListServer, RongIMSDKServer) {
                ...
                this.template = '<div class="rongcloud-chatList">' +
                    ...
                    '<img class="rongcloud-img" ng-src="{{item.portraitUri}}" err-src="https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=2003988139,3010807873&fm=117&gp=0.jpg" alt="">' +
...
(function (RongWebIMWidget) {
    ...
    var WebIMWidget = (function () {
        ...
        WebIMWidget.prototype.initStyle = function (defaultStyle) {
            ...
            if (defaultStyle) {
                eleconversation.style["height"] = "100%";
                eleconversation.style["width"] = "auto";
                eleconversationlist.style["height"] = "100%";
...
(function (RongWebIMWidget) {
    var RongIMSDKServer = (function () {
        ...
        RongIMSDKServer.prototype.registerMessage = function () {
            ...
            var mesasgeTag = new RongIMLib.MessageTag(true, true); // 消息是否保存是否计数，true
																	// true
																	// 保存且计数，false
																	// false
																	// 不保存不计数。
...
angular.module('RongWebIMWidget').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('./ts/conversation/conversation.tpl.html',
    "<div id=rong-conversation class=\"rongcloud-kefuChatBox rongcloud-both rongcloud-am-fade-and-slide-top\" ng-show=showSelf ng-class=\"{'rongcloud-fullScreen':resoures.fullScreen}\">" +
    ...
    "<div class=rongcloud-kefuChat><div id=header class=\"rongcloud-rong-header rongcloud-blueBg rongcloud-online\">" +
    "<div class=\"rongcloud-infoBar rongcloud-pull-left\"><div class=rongcloud-infoBarTit>" +
    "<span class=rongcloud-kefuName ng-bind=conversation.title></span>" +
    "</div></div><div class=\"rongcloud-toolBar rongcloud-headBtn rongcloud-pull-right\">" +
    "<div ng-show=!config.displayConversationList&&config.voiceNotification class=rongcloud-voice ng-class=\"{'rongcloud-voice-mute':!data.voiceSound,'rongcloud-voice-sound':data.voiceSound}\" ng-click=\"data.voiceSound=!data.voiceSound\"></div><a href=javascript:; class=\"rongcloud-kefuChatBoxHide rongcloud-sprite\" style=margin-right:6px ng-show=!config.displayConversationList ng-click=minimize() title=隐藏></a>" +
    " <a href=javascript:; class=\"rongcloud-kefuChatBoxClose rongcloud-sprite\" ng-click=close() title=结束对话></a></div></div>" +
    "<div class=rongcloud-outlineBox ng-hide=data.connectionState><div class=rongcloud-sprite></div><span>连接断开,请刷新重连</span></div>" +
    "<div id=Messages><div class=rongcloud-emptyBox>暂时没有新消息</div><div class=rongcloud-MessagesInner><div ng-repeat=\"item in messageList\" ng-switch=item.panelType>" +
    "<div class=rongcloud-Messages-date ng-switch-when=104><b>{{item.sentTime|historyTime}}</b></div>" +
    "<div class=rongcloud-Messages-history ng-switch-when=105><b ng-click=getHistory()>查看历史消息</b></div>" +
    "<div class=rongcloud-Messages-history ng-switch-when=106><b ng-click=getMoreMessage()>获取更多消息</b></div>" +
    ...
    "<div class=rongcloud-Messages-unreadLine></div><div><div class=rongcloud-Message-header>" +
    "<img class=\"rongcloud-img rongcloud-u-isActionable rongcloud-Message-avatar rongcloud-avatar\" ng-src={{item.content.userInfo.portraitUri||item.content.userInfo.icon}} err-src=http://7xo1cb.com1.z0.glb.clouddn.com/rongcloudkefu2.png errsrcserasdfasdfasdfa alt=\"\">" +
    ...
    "<div class=rongcloud-expressionWrap ng-show=showemoji><i class=rongcloud-arrow></i><emoji ng-repeat=\"item in emojiList\" item=item content=conversation></emoji></div></div>" +
    "<div class=rongcloud-MessageForm-tool><i class=\"rongcloud-sprite rongcloud-iconfont-upload\" id=upload-file style=\"position: relative; z-index: 1\"></i></div></div><div class=rongcloud-mode2 ng-show=\"_inputPanelState==2\">" +
    "<a ng-click=switchPerson() id=chatSwitch class=rongcloud-chatSwitch>转人工服务</a></div></div><pre id=inputMsg class=\"rongcloud-text rongcloud-grey\" contenteditable contenteditable-dire ng-focus=\"showemoji=fase\" style=\"background-color: rgba(0,0,0,0);color:black\" ctrl-enter-keys fun=send() ctrlenter=false placeholder=请输入文字... ondrop=\"return false\" ng-model=conversation.messageContent></pre></div>" +
    "<div class=rongcloud-powBox><button type=button style=\"background-color: #0099ff\" class=\"rongcloud-rong-btn rongcloud-rong-send-btn\" id=rong-sendBtn ng-click=send()>发送</button></div></div></div></div></div>"
  );
