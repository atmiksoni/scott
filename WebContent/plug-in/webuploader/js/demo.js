Upload = function(option) {
	...
	var statusBar = $('.statusBar'); // 状态栏，包括进度和控制按钮
	var info = $('.info'); // 文件总体选择信息。
	var uploadBtn = $('.uploadBtn'); // 上传按钮
	var placeHolder = $('.placeholder'); // 没选择文件之前的内容。
	...
	var thumbnailWidth = 110 * ratio; // 缩略图大小
