!function($) {
	...
	var dismiss = '[data-dismiss="tags"]', Tags = function(element, options) {
	...
	Tags.prototype.addTag = function(data) {
		var opts = this.options, $tag = $(opts.template)
	...
	Tags.prototype.removeTag = function(key) {
		var opts = this.options, $tag = this.$element.find('.tag[data-tag-value="' + key + '"]')
	...
	Tags.prototype.close = function(e) {
		var $this = $(this), $parent = $this.parent('.tag').first(), api = $this.parents('.tags').first().data('tags')
	...
	$.fn.tags = function(option) {
		return this.each(function() {
			var $this = $(this), data = $this.data('tags')
			if (!data)
				$this.data('tags', (data = new Tags(this, option)))
	...
	$.fn.tags.defaults = {
		...
		template : '<span class="tag"><a href="javascript:void(0)" class="close" data-dismiss="tags">×</a><span class="tag-content"></span></span>'
	}
