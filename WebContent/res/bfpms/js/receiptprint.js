function receiptprint(params) {
	LODOP = getLodop(document.getElementById("LODOP"), document.getElementById("LODOP_EM"));
	var PRINT_SIZE = 6;// 一页打印数量
	...
	var UNIT = "mm";
	top.Dg.z.ajax("receipt/print_receipt_sub.do", params, function(data) {
		init(data);
		...
		LODOP.ADD_PRINT_TEXT(50, 520, 200, 20, "No." + data.printNo);
		LODOP.SET_PRINT_STYLEA(0, "FontName", "宋体");
		...
		LODOP.SET_PREVIEW_WINDOW(1,1,1,800,600,data.title+".打印收据");
